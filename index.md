...
3. 프린터 API 백엔드 &nbsp;
4. 광고주용 실시간 리포트 페이지 &nbsp;
5. 프린터관리자용 실시간 프린팅 및 정산 정보 확인 페이지 &nbsp;
6. 내부 관리용 페이지 &nbsp;
...
## And more?
지금까지 저희 서비스 구성 Stack에 대해 공유 드렸는데요, 애드투페이퍼 앱에도 흥미로운 공유사항들이 많이 있습니다. 살짝 공유하자면 저희 앱은 100% HTML로 제작되어서 단일 코드 베이스로 iOS / Android 플랫폼 양쪽에 배포하고 있는데요, 후속 포스팅에서 자세히 공유하도록 하겠습니다.
