...
2. 현재 윈도우 클라이언트의 UI는 내장된 Chrome ([CEF](https://code.google.com/p/chromiumembedded/)) 위에서 동작하는 HTML5 웹앱입니다. 웹 관련 기술에 관심이 있으시면 좋지만 필수는 아닙니다. (UI는 웹개발자들이 담당하고 있습니다. <strike>UI 개발은 신경 쓰지 않으셔도 되니 걱정하지 마세요.</strike>)
